...
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="cost_center_id" class=" col-md-3"><?php echo app_lang('cost_center'); ?></label>
                <div class=" col-md-9">
                    <?php
                    echo form_dropdown(
                        "cost_center_id",
                        $cost_centers_dropdown,
                        array($model_info->cost_center_id ?? ""),
                        "class='select2' id='cost_center_id'"
                    );
                    ?>
                </div>
            </div>
