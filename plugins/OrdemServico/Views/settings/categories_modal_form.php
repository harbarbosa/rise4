<?php echo form_open(get_uri("ordemservico/categories_save"), array("id" => "os-categories-form", "class" => "general-form", "role" => "form")); ?>
...
<script>
$(function(){
  $("#os-categories-form").appForm({
    isModal: true,
    onSuccess: function (result) {
      if (result && result.success) {
        $("#os-categories-table").appTable({newData: result.data, dataId: result.id});
