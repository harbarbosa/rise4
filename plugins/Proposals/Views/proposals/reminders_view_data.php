<?php
$plugin_proposal_id = isset($plugin_proposal_id) ? (int)$plugin_proposal_id : 0;
$hide_form = isset($hide_form) ? $hide_form : false;
$reminder_id_prefix = "plugin-proposal-";
...
<div id="<?php echo $reminder_id_prefix . 'reminder-form-container'; ?>" class="<?php echo $hide_form ? "hide" : ""; ?>">
    ...
    <input type="hidden" name="plugin_proposal_id" value="<?php echo $plugin_proposal_id; ?>" />
...
<script type="text/javascript">
    ...
    var proposalId = "<?php echo $plugin_proposal_id; ?>";
    ...
    $(document).ready(function() {
        ...
        loadReminderTable = function(type) {
            ...
            $tableSelector.appTable({
                source: '<?php echo_uri("propostas/reminders/list_data"); ?>/' + proposalId + '/' + type,
                hideTools: true,
                order: [[0, "asc"]],
                displayLength: 100,
                columns: [
