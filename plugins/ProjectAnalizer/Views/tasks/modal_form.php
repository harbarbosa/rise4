                ...
                <div class="row">
                    ...
                    <div class="col-md-9">
                        ...
                        <?php foreach ($task_materials as $index => $row) { $options = str_replace("value='" . esc($row->proposal_item_id) . "'", "value='" . esc($row->proposal_item_id) . "' selected", $material_options); ?>
                            ...
                            <td><input type="text" inputmode="decimal" name="task_materials[<?php echo $index; ?>][quantity]" value="<?php echo esc($row->quantity); ?>" class="form-control" /></td>
