...
class Notes_model extends Crud_model {
    ...
    function get_details($options = array()) {
        ...
        $sql = "SELECT $notes_table.*, CONCAT($users_table.first_name, ' ', $users_table.last_name) AS created_by_user_name, $users_table.image AS created_by_avatar, $note_category_table.name AS category_name, $select_labels_data_query
        FROM $notes_table
