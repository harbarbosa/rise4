...
echo form_open(get_uri('frota/manutencoes/salvar'), ['id' => 'frota-maintenance-form', 'class' => 'general-form', 'role' => 'form']);
?>
<div class="modal-body clearfix"><div class="container-fluid">
    ...
    <div class="form-group"><div class="row"><label for="cost" class="col-md-3">Custo</label><div class="col-md-9">
        <?php echo form_input(['id'=>'cost','name'=>'cost','value'=>$model_info->cost ?? '','class'=>'form-control frota-currency-mask','data-decimals'=>'2','placeholder'=>'R$ 0,00','inputmode'=>'decimal']); ?>
    </div></div></div>
...
$(document).ready(function(){
    if(window.FrotaUI){window.FrotaUI.prepareMasks('#frota-maintenance-form');}
