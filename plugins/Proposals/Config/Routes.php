...
$routes->post('propostas/followup_modal_form', 'Proposals::followup_modal_form', ['namespace' => 'Proposals\\Controllers']);
$routes->post('propostas/followup_modal_form/(:num)', 'Proposals::followup_modal_form/$1', ['namespace' => 'Proposals\\Controllers']);
$routes->post('propostas/save_followup', 'Proposals::save_followup', ['namespace' => 'Proposals\\Controllers']);
$routes->post('propostas/complete_followup/(:num)', 'Proposals::complete_followup/$1', ['namespace' => 'Proposals\\Controllers']);
...
$routes->post('propostas/file_modal_form', 'Proposals::file_modal_form', ['namespace' => 'Proposals\\Controllers']);
