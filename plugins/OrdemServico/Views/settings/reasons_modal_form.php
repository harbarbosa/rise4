<?php echo form_open(get_uri("ordemservico/reasons_save"), array("id" => "os-reasons-form", "class" => "general-form", "role" => "form")); ?>
...
<script>
$(function(){
  $("#os-reasons-form").appForm({
    isModal: true,
    onSuccess: function (result) {
      if (result && result.success) {
        $("#os-reasons-table").appTable({newData: result.data, dataId: result.id});
