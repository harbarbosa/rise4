...
$routes->get('pontorh/locais', 'PontoRH_locations::index', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/list_data', 'PontoRH_locations::list_data', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/modal_form', 'PontoRH_locations::modal_form', ['namespace' => 'PontoRH\Controllers']);
$routes->get('pontorh/locais/modal_form/(:num)', 'PontoRH_locations::modal_form/$1', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/save', 'PontoRH_locations::save', ['namespace' => 'PontoRH\Controllers']);
$routes->get('pontorh/locais/detalhes/(:num)', 'PontoRH_locations::details/$1', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/view_modal', 'PontoRH_locations::view_modal', ['namespace' => 'PontoRH\Controllers']);
$routes->get('pontorh/locais/view_modal/(:num)', 'PontoRH_locations::view_modal/$1', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/assignment_modal', 'PontoRH_locations::assignment_modal', ['namespace' => 'PontoRH\Controllers']);
$routes->get('pontorh/locais/assignment_modal/(:num)', 'PontoRH_locations::assignment_modal/$1', ['namespace' => 'PontoRH\Controllers']);
$routes->post('pontorh/locais/assignment_save', 'PontoRH_locations::assignment_save', ['namespace' => 'PontoRH\Controllers']);
...
$routes->post('pontorh/tratamento/modal_form/(:num)', 'PontoRH_treatment::modal_form/$1', ['namespace' => 'PontoRH\Controllers']);
