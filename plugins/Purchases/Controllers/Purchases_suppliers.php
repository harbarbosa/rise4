...
class Purchases_suppliers extends Security_Controller
{
    ...
    public function index()
    {
        ...
        return $this->template->rander('Purchases\\Views\\suppliers\\index');
    }
    ...
    public function list_data()
    {
        ...
        $list_data = $this->Purchases_suppliers_model->get_details($options)->getResult();
        $result = array();
    ...
    public function modal_form()
    {
        ...
        $view_data['model_info'] = $this->Purchases_suppliers_model->get_one($id);
        return $this->template->view('Purchases\\Views\\suppliers\\modal_form', $view_data);
    }
    ...
    public function save()
    {
        ...
        $save_id = $this->Purchases_suppliers_model->ci_save($data, $id);
        if ($save_id === false) {
        ...
        $row = $this->Purchases_suppliers_model->get_one($new_id);
    ...
    public function delete()
    {
        ...
        $ok = $this->Purchases_suppliers_model->delete($id);
        return $this->response->setJSON(array('success' => $ok ? true : false));
    }

    private function _make_row($data)
    {
        $actions = modal_anchor(get_uri('purchases_suppliers/modal_form'), "<i data-feather='edit' class='icon-16'></i>", array(
            'title' => app_lang('edit'),
        ...
        $actions .= ' ' . js_anchor("<i data-feather='x' class='icon-16'></i>", array(
            ...
            'data-id' => $data->id,
            'data-action-url' => get_uri('purchases_suppliers/delete'),
