...
class CreateLaudosTecnicosSettings extends Migration
{
    public function up()
    {
        $table = $this->db->prefixTable('laudo_settings');
        ...
        $this->forge->createTable('laudo_settings', true, array(
            'ENGINE' => 'InnoDB',
    ...
    {
        $this->forge->dropTable('laudo_settings', true);
    }
}
