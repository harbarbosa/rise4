...
echo form_open(get_uri('frota/abastecimentos/salvar'), ['id' => 'frota-fueling-form', 'class' => 'general-form', 'role' => 'form']);
?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group"><div class="row"><label for="fueling_at" class="col-md-3">Data/hora</label><div class="col-md-9">
            <?php
        ...
        <div class="form-group"><div class="row"><label for="odometer" class="col-md-3">KM</label><div class="col-md-9">
            <?php echo form_input(['id'=>'odometer','name'=>'odometer','value'=>$model_info->odometer ?? '','class'=>'form-control frota-km-mask','placeholder'=>'111.111.111','inputmode'=>'numeric','data-rule-required'=>true,'data-msg-required'=>app_lang('field_required')]); ?>
        </div></div></div>

        <div class="form-group"><div class="row"><label for="liters" class="col-md-3">Litros</label><div class="col-md-9">
            <?php echo form_input(['id'=>'liters','name'=>'liters','value'=>$model_info->liters ?? '','class'=>'form-control frota-decimal-mask','data-decimals'=>'3','placeholder'=>'0,000','inputmode'=>'decimal','data-rule-required'=>true,'data-msg-required'=>app_lang('field_required')]); ?>
        </div></div></div>

        <div class="form-group"><div class="row"><label for="unit_price" class="col-md-3">Preço por litro</label><div class="col-md-9">
            <?php echo form_input(['id'=>'unit_price','name'=>'unit_price','value'=>$model_info->unit_price ?? '','class'=>'form-control frota-currency-mask','data-decimals'=>'3','placeholder'=>'R$ 0,000','inputmode'=>'decimal','data-rule-required'=>true,'data-msg-required'=>app_lang('field_required')]); ?>
        </div></div></div>

        <div class="form-group"><div class="row"><label for="total_amount" class="col-md-3">Valor total</label><div class="col-md-9">
            <?php echo form_input(['id'=>'total_amount','name'=>'total_amount','value'=>$model_info->total_amount ?? '','class'=>'form-control frota-currency-mask','data-decimals'=>'2','placeholder'=>'R$ 0,00','readonly'=>true]); ?>
