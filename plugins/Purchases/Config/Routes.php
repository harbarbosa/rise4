...
$routes->post('purchases_requests/update_status/(:num)/(:any)', 'Purchase_requests::update_status/$1/$2', ['namespace' => 'Purchases\\Controllers']);
$routes->post('purchases_requests/update_status/(:num)', 'Purchase_requests::update_status/$1', ['namespace' => 'Purchases\\Controllers']);
$routes->get('purchases_requests/update_status/(:num)/(:any)', 'Purchase_requests::update_status/$1/$2', ['namespace' => 'Purchases\\Controllers']);
$routes->get('purchases_requests/update_status/(:num)', 'Purchase_requests::update_status/$1', ['namespace' => 'Purchases\\Controllers']);
