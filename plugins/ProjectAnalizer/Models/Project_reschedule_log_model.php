...
class Project_reschedule_log_model extends Crud_model
{
    protected $table = null;

    public function __construct()
    {
        $this->table = "projectanalizer_project_reschedule_log";
    ...
    {
        $result = $this->get_details(array("project_id" => $project_id));
