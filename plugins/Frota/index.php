...
app_hooks()->add_filter('app_filter_staff_left_menu', function ($sidebar_menu) {
    ...
    $sidebar_menu['frota'] = [
        ...
        'submenu' => [
            'frota_dashboard' => ['name' => 'Visão geral', 'url' => get_uri('frota'), 'class' => 'bar-chart-2'],
            'frota_veiculos' => ['name' => 'Veículos', 'url' => get_uri('frota/veiculos'), 'class' => 'truck'],
            'frota_abastecimentos' => ['name' => 'Abastecimentos', 'url' => get_uri('frota/abastecimentos'), 'class' => 'droplet'],
            'frota_manutencoes' => ['name' => 'Manutenções', 'url' => get_uri('frota/manutencoes'), 'class' => 'tool'],
            'frota_ocorrencias' => ['name' => 'Ocorrências', 'url' => get_uri('frota/ocorrencias'), 'class' => 'alert-triangle'],
        ],
    ];
    return $sidebar_menu;
});
