                        ...
                        <div role="tabpanel" class="tab-pane" id="configuration-tab">
                            <form name="config-form" id="config-form" action="do_install.php" method="post">
                                ...
                                <div class="section clearfix" style="display:none;">
                                    <p>3. License validation (optional).</p>
                                    <hr />
                                    <div>
                                        <div class="form-group clearfix">
                                            <div class="row">
                                                <label for="purchase_code" class=" col-md-3">License key (optional)</label>
                                                <div class="col-md-9">
                                                    <input type="text" value="ACTIVATED"  id="purchase_code"  name="purchase_code" class="form-control"  placeholder="Pre-activated license" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
