    ...
    <div class="card">
        ...
        <div class="card-body">
            ...
            <ul class="permission-list">
                ...
                try {
                    if (!defined('PURCHASES_ROLE_PERMISSIONS_RENDERED') && defined('PLUGINPATH')) {
                        $purchases_permissions_view = PLUGINPATH . 'Purchases/Views/permissions/role_permissions.php';
                        if (file_exists($purchases_permissions_view)) {
                            $permissions = $permissions;
                            include $purchases_permissions_view;
