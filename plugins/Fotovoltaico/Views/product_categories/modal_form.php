<?php echo form_open(get_uri("fotovoltaico/product_categories/save"), array("id" => "product-category-form", "class" => "general-form", "role" => "form")); ?>
<div class="modal-body clearfix">
    <div class="container-fluid">
        ...
        <div class="form-group">
            <div class="row">
                <label for="description" class="col-md-3"><?php echo app_lang('fotovoltaico_description'); ?></label>
                <div class="col-md-9">
        ...
        <div class="form-group">
            <div class="row">
                ...
                <div class="col-md-9">
                    <?php echo form_input(array("id" => "sort", "name" => "sort", "value" => $model_info->sort, "class" => "form-control")); ?>
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    $(document).ready(function () {
        $("#product-category-form").appForm({
            onSuccess: function (result) {
                if (result && result.success) {
                    $("#product-categories-table").appTable({newData: result.data, dataId: result.id});
                }
            }
        });
