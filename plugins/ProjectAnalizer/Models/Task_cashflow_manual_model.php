...
class Task_cashflow_manual_model extends Crud_model
{
    protected $table = null;

    public function __construct()
    {
        $this->table = "projectanalizer_task_cashflow_manual";
    ...
    public function get_details($options = array())
    {
        ...
        $sql = "SELECT $table.* FROM $table WHERE $table.deleted=0 $where ORDER BY $table.date ASC";
