...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        var smartFilterContext = "projectanalizer_tasks_gantt";
        <?php if (!$project_id) { ?>
            smartFilterContext = "projectanalizer_all_tasks_gantt";
        <?php } ?>

        var statusOptions = <?php echo $status_dropdown; ?>;
        var defaultStatusIds = statusOptions.map(function(item) {
            return item.id;
        });
        ...
        $("#gantt-filters").appFilters({
            ...
            smartFilterIdentity: smartFilterContext,
            ignoreSavedFilter: true,
            filterParams: {
                customFilter: true,
                status_id: defaultStatusIds
            },
            contextMeta: {
